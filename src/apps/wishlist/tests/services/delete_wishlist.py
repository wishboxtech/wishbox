...
class DeleteWishlistByIdServiceTestCase(TestCase):
    def setUp(self):
        self.faker = Faker()
    ...
    def test_delete_wishlist_by_valid_uuid(self):
        ...
        result = delete_wishlist(self.wishlist.id)
    ...
    def test_delete_wishlist_by_valid_string_id(self):
        ...
        result = delete_wishlist(str(wishlist.id))
        self.assertTrue(result)
    ...
    def test_delete_wishlist_by_nonexistent_uuid(self):
        ...
        result = delete_wishlist(non_existent_id)
