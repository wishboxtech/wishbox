...
class DeleteWishByIdSelectorTestCase(TestCase):
    def setUp(self):
        self.faker = Faker()
    ...
    def test_delete_wish_by_valid_uuid(self):
        ...
        result = delete_wish_by_id(self.wish.id)
    ...
    def test_delete_wish_by_valid_string_id(self):
        ...
        wish = WishFactory()
        result = delete_wish_by_id(str(wish.id))
        self.assertTrue(result)
    ...
    def test_delete_wish_by_nonexistent_uuid(self):
        ...
        result = delete_wish_by_id(non_existent_id)
